...
def seed_default_data(force: bool = False):
    ...
    try:
        ...
        users_data = [
            ...
            {
                "employee_id": "OISEKU20230002",
                "email": "senthil@dayflow.com",
                ...
                "about": "Experienced HR specialist dedicated to talent development, workplace culture, and operational excellence.",
                "what_i_love": "Empowering teams, driving positive culture, and streamlining HR workflows.",
                "interests_and_hobbies": "Mentoring, reading, traveling, and cricket.",
                "skills": "HR Operations, Talent Acquisition, People Management, Employee Relations, Policy Design",
                "certifications": "SHRM Certified Professional (SHRM-CP), HRCI Senior Professional in HR",
                "date_of_birth": date(1995, 4, 12),
                "nationality": "Indian",
                "personal_email": "senthil.kumar@gmail.com",
                "gender": "Male",
